...
func TestProcessCoverArtChanges(t *testing.T) {
	...
	t.Run("adding single", func(t *testing.T) {
		...
		dtos := &[]UpdateCoverArtDTO{
			{Volume: ptr("1"), ObjectName: "staging-obj-1", Description: ptr("Cover for volume 1")},
		}
		...
		assert.Equal(t, ptr("1"), result.Added[0].Volume)
	...
	t.Run("empty volumes", func(t *testing.T) {
		existing := []model.CoverArt{
			{Volume: nil, ObjectName: "perma-obj-1", Description: ptr("existing cover with empty volume")},
			{Volume: nil, ObjectName: "perma-obj-2", Description: ptr("deleting cover with empty volume")},
		}
		dtos := &[]UpdateCoverArtDTO{
			{Volume: nil, ObjectName: "perma-obj-1", Description: ptr("existing cover with empty volume")},
			{Volume: nil, ObjectName: "staging-obj-3", Description: ptr("cover with empty volume")},
			{Volume: nil, ObjectName: "staging-obj-4", Description: ptr("another cover with empty volume")},
		}
	...
	t.Run("replace single (obj changed)", func(t *testing.T) {
		existing := []model.CoverArt{
			{Volume: ptr("1"), ObjectName: "perma-obj-1", Description: ptr("Old cover")},
		}
		dtos := &[]UpdateCoverArtDTO{
			{Volume: ptr("1"), ObjectName: "staging-obj-2", Description: ptr("New cover")},
		}
	...
	t.Run("update single (obj unchanged)", func(t *testing.T) {
		existing := []model.CoverArt{
			{Volume: ptr("1"), ObjectName: "perma-obj-1", Description: ptr("Old desc")},
		}
		dtos := &[]UpdateCoverArtDTO{
			{Volume: ptr("1"), ObjectName: "perma-obj-1", Description: ptr("Updated desc")},
		}
		...
		assert.Len(t, result.Updated, 1)
		assert.Equal(t, ptr("1"), result.Updated[0].Volume)
		assert.Equal(t, "perma-obj-1", result.Updated[0].ObjectName)
		assert.Equal(t, ptr("Updated desc"), result.Updated[0].Description)
	...
	t.Run("delete single", func(t *testing.T) {
		existing := []model.CoverArt{
			{Volume: ptr("1"), ObjectName: "perma-obj-1", Description: ptr("Cover")},
		}
		dtos := &[]UpdateCoverArtDTO{}
		...
		assert.Len(t, result.Deleted, 1)
		assert.Equal(t, ptr("1"), result.Deleted[0].Volume)
		assert.Equal(t, "perma-obj-1", result.Deleted[0].ObjectName)
	})

	t.Run("mixed operations", func(t *testing.T) {
		existing := []model.CoverArt{
			{Volume: nil, ObjectName: "perma-obj-0", Description: ptr("Cover with empty volume")},
			{Volume: ptr("1"), ObjectName: "perma-obj-1", Description: ptr("Cover 1")},
			{Volume: ptr("2"), ObjectName: "perma-obj-2", Description: ptr("Cover 2")},
			{Volume: ptr("3"), ObjectName: "perma-obj-6", Description: ptr("Cover 3")},
		}
		dtos := &[]UpdateCoverArtDTO{
			{Volume: ptr("1"), ObjectName: "perma-obj-1", Description: ptr("Cover 1")},       // unchanged
			{Volume: ptr("2"), ObjectName: "staging-obj-2", Description: ptr("New Cover 2")}, // replaced
			{Volume: ptr("4"), ObjectName: "staging-obj-4", Description: ptr("New Cover 4")}, // added
			{Volume: ptr("5"), ObjectName: "perma-obj-6", Description: ptr("Cover 5")},       // updated (same object, volume changed)
		}
	...
	t.Run("nil dtos returns existing as updated", func(t *testing.T) {
		existing := []model.CoverArt{
			{Volume: ptr("1"), ObjectName: "perma-obj-1"},
		}
